...
def get_extra_rewards_airdrop(wallet, block, blockchain, execution=1, web3=None, index=0, decimals=True):
    ...
    try:
        ...
        return get_extra_rewards_airdrop(wallet, block, blockchain, decimals=decimals, index=index,
...
def get_all_rewards(wallet, lptoken_address, block, blockchain, execution=1, web3=None, index=0, decimals=True,
    ...
    try:
        ...
        return get_all_rewards(wallet, lptoken_address, block, blockchain, decimals=decimals,
                               bal_rewards_contract=bal_rewards_contract, index=index, execution=execution + 1)
...
def get_locked(wallet, block, blockchain, execution=1, web3=None, index=0, reward=False, decimals=True):
    ...
    try:
        ...
        return get_locked(wallet, block, blockchain, reward=reward, decimals=decimals, index=index,
                          execution=execution + 1)
...
def get_staked_aurabal(wallet, block, blockchain, web3=None, execution=1, index=0, reward=False, decimals=True):
    ...
    try:
        ...
        return get_staked_aurabal(wallet, block, blockchain, reward=reward, decimals=decimals, index=index,
                                  execution=execution + 1)
        ...
        traceback.print_exc()
        return get_staked_aurabal(wallet, block, blockchain, reward=reward, decimals=decimals, index=index + 1,
                                  execution=execution)
...
def underlying(wallet, lptoken_address, block, blockchain, web3=None, execution=1, index=0, reward=False,
    ...
    try:
        ...
        return underlying(wallet, lptoken_address, block, blockchain, reward=reward, decimals=decimals,
                          no_balancer_underlying=no_balancer_underlying, index=index, execution=execution + 1)
