...
class %(name)s:
    ...
    def __init__(self, blockchain: str, block: int, address: str | None = None) -> None:
        ...
        self.contract = node.eth.contract(address=address, abi=load_abi(__file__, %(abi)r))\n
"""
...
def generate_classes():
    ...
    for setup_path in setup_paths:
        ...
        with open(autogenerated_module_path, "w") as f:
            f.write(header_template % dict(
                classes=", ".join(classes_name),
                first_class= classes_name[0]
            ))
            f.write(content)
