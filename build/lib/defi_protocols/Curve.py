...
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
def get_gauge_version(gauge_address, block, blockchain, **kwargs):
    ...
    try:
        only_version = kwargs['only_version']
    except:
        only_version = True
    ...
    try:
        ...
        return get_gauge_version(gauge_address, block, blockchain, web3 = web3, index = index, execution = execution + 1)
        ...
        traceback.print_exc()
        return get_gauge_version(gauge_address, block, blockchain, web3 = web3, index = index + 1, execution = execution)
...
def underlying(wallet, lptoken_address, block, blockchain, **kwargs):
    ...
    try:
        ...
        if reward == True:
            ...
            all_rewards = get_all_rewards(wallet, lptoken_address, block, blockchain, web3 = web3, decimals = decimals, gauge_address = lptoken_data['gauge'], index = index)
...
# 1 - List of Tuples: [liquidity_token_address, balance, staked_balance]
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
def underlying_amount(lptoken_amount, lptoken_address, block, blockchain, **kwargs):
