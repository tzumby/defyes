# Python package for Karpatkey Defi Protocols
...
data = bf.get_contract_abi('0xdAC17F958D2ee523a2206206994597C13D831ec7', 'ethereum')

print(data)

data = gc.API_KEY_ETHERSCAN

print(data)

data = Aave.get_protocol_data_provider('ethereum')

print(data)

```

Above snippet should give you proper output as below

```

(⎈|default:default)➜  package-testing python3 test.py
...
W1TK6XRQHME8X29PATD7YSXEHZ2QZJQPZE
