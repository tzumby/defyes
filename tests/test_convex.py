...
from defyes.constants import CRV_ETH, CVX_ETH, CVXCRV_ETH, DAI_ETH, Chain, LDO_ETH, USDC_ETH, USDT_ETH, X3CRV_ETH
...
def test_get_all_rewards():
    all_rewards = Convex.get_all_rewards(
        "0x704617048F435cB679252E24148638211fb4457D", X3CRV_ETH, 17499865, Chain.ETHEREUM, web3
    )
...
def test_pool_balances():
    balances = Convex.pool_balances(X3CRV_ETH, 16993460, Chain.ETHEREUM, web3, decimals=False)
    assert balances == [
