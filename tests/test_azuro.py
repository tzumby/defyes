...
from defyes.constants import WXDAI, Chain
...
def test_get_deposit():
    assert Azuro.get_deposit(WALLET_N1, NFT_ID, Azuro.POOL_ADDR_V2, BLOCK, Chain.XDAI, NODE) == 500000000000000000000000


def test_underlying():
    assert Azuro.underlying(WALLET_N1, NFT_ID, BLOCK, Chain.XDAI, NODE, rewards=True) == [
