...
def test_underlying():
    assert [[WXDAI, 522184.83378876065],
            [WXDAI, 22184.83378876065]] == Azuro.underlying(WALLET_N1, NFT_ID, BLOCK, XDAI, NODE, rewards=True)
...
def test_underlying_all():
    assert [[[WXDAI, 2327299.1842438867], [WXDAI, 27299.184243886655]],
            ...
            [[WXDAI, 2327299.1842438867], [WXDAI, 27299.184243886655]]] == Azuro.underlying_all(WALLET_N1, BLOCK, XDAI, NODE, rewards=True)
