...
def test_underlying(decimals):
    ...
    assert x == [[[FTM_ETH, Decimal('1000000000000000000') / y18],
                 ...
                 [[WOOFY_ETH, Decimal('559232649388782') / y12],
                  [USDP, Decimal('-8724323954416268170') / y18]],

                 [[xSUSHI_ETH, Decimal('300000000000000000') / y18],
                  [USDP, Decimal('-1304849446951977717') / y18]],

                 [[X3CRV_Gauge_Unit_ETH, Decimal('2400000000000000000') / y18],
                  [USDP, Decimal('-1660386168669741637') / y18]],

                 [[yvYFI_ETH, Decimal('642818733893975') / y18],
                  [USDP, Decimal('-3889516423093472424') / y18]],

                 [[EURS_ETH, Decimal('400') / y2],
                  [USDP, Decimal('-2064283359842719431') / y18]],
                 [[wuSSLPWETHUSDT_ETH, Decimal('760053991711') / y18],
                  [USDP, Decimal('-19645142679366516132') / y18]],
                 [[USG_ETH, Decimal('1000000000000000000') / y18],
                  [USDP, Decimal('-1000000000000000000') / y18]]]
