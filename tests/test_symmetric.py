...
def test_underlying(decimals):
    ...
    wallet_v1 = '0x9b04a9eee500302980a117f514bc2de0fd1f683d'
    lptoken_address_v1 = '0x53ED0C2C6bB944D9421528E1ABD1e042B330696b'
    underlying_v1 = Symmetric.underlying(wallet_v1, lptoken_address_v1, block, XDAI, node, reward=False, decimals=decimals)
    assert underlying_v1 == \
            {
                ...
                'unstaked': [{
                    'token': '0x9C58BAcC331c9aa871AFD802DB6379a98e80CEdb',
                    'balance': Decimal('0.09918343265529906587633112982') if decimals else Decimal('99183432655299065.87633112982')
                }, {
                    'token': '0xe91D153E0b41518A2Ce8Dd3D7944Fa863463a97d',
                    'balance': Decimal('8.122041293585052913340697534') if decimals else Decimal('8122041293585052913.340697534')
                }
                ]
            }
    block = 27444181
    wallet_v2 = '0x2c640AC98E293Daa246F98D2828E328A06FA6936'
    lptoken_address_v2 = '0x650f5d96E83d3437bf5382558cB31F0ac5536684'
    underlying_v2 = Symmetric.underlying(wallet_v2, lptoken_address_v2, block, XDAI, node, reward=False, decimals=decimals)
    assert underlying_v2 == \
           {
               ...
               'staked': [
                   {
                       'token': '0x9C58BAcC331c9aa871AFD802DB6379a98e80CEdb',
                       'balance': Decimal('0.05341158140134450336962264979') if decimals else Decimal('53411581401344503.36962264979')
                   },
                   {
                       'token': '0xe91D153E0b41518A2Ce8Dd3D7944Fa863463a97d',
                       'balance': Decimal('1.456160176840211550792382223') if decimals else Decimal('1456160176840211550.792382223')
                   }
               ]
           }
    underlying_v2_reward = Symmetric.underlying(wallet_v2, lptoken_address_v2, block, XDAI, node, reward=True, decimals=decimals)
    ...
    assert rewards ==\
           {
               ...
               'reward_rates': [
                   ...
                   {
                       'token': '0x9C58BAcC331c9aa871AFD802DB6379a98e80CEdb',
                       'rewards_per_second': Decimal('0.000005573390404850898876404494382') if decimals else Decimal('5573390404850.898876404494382')
                   }
               ]
           }