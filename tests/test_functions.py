...
def test_search_proxy_impl_address():
    ...
    implementation = search_proxy_impl_address("0x793fAF861a78B07c0C8c0ed1450D3919F3473226", Chain.GNOSIS, block=31782206)
    assert implementation == "0x45fFd460cC6642B8D8Fb12373DFd77Ceb0f4932B"

    # Custom proxy implementation (similar to EIP-1167)
    implementation = search_proxy_impl_address("0x09cabEC1eAd1c0Ba254B09efb3EE13841712bE14", Chain.ETHEREUM, block=16475978)
    ...
    implementation = search_proxy_impl_address("0x3d9819210A31b4961b30EF54bE2aeD79B9c9Cd3B", Chain.ETHEREUM, block=18934617)
    assert implementation == "0xBafE01ff935C7305907c33BF824352eE5979B526"

    # Custom proxy implementation (used by Safes)
    implementation = search_proxy_impl_address("0x4F2083f5fBede34C2714aFfb3105539775f7FE64", Chain.ETHEREUM, block=18934617)
