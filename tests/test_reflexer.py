...
def test_underlying():
    ...
    assert underlying == [
        [ETHTokenAddr.FLX, Decimal("48390.17697598300981895886497")],
...
def test_lptoken_underlying():
    ...
    assert underlying == [[ETHTokenAddr.FLX, Decimal("0")], [ETHTokenAddr.WETH, Decimal("0.0000")]]
...
def test_pool_balances():
    ...
    assert underlying == [
        [ETHTokenAddr.FLX, Decimal("124449.671679348329429663")],
