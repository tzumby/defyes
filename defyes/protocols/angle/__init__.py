...
class VaultManager(VaultManager):
    ...
    def get_vault_data(self, vaultid: int, decimals: bool = True) -> dict:
        ...
        debt_amount = self.get_vault_debt(vaultid)  # / Decimal(10**stablecoin_decimals)
        ...
        print("1", collateral_deposit, normalized_debt)
        collateral_amount = collateral_deposit  # / Decimal(10**collateral_decimals)
        collateral = TokenAmount.from_teu(collateral_amount, Token.get_instance(self.collateral, self.blockchain))
        print(2, self.collateral, collateral)
        ...
        # health_factor = collateral_in_stablecoin * collateral_factor / debt_amount

        available_to_borrow = collateral_in_stablecoin * collateral_factor - debt_amount

        interest_rate_per_second = self.interest_rate / Decimal(10**interest_decimals)
        print(3, interest_rate_per_second)
        ...
        data = {
            ...
            "financial_metrics": {
                ...
                "liquidation_price_in_stablecoin_fiat": debt_amount / collateral_factor / collateral_amount,
